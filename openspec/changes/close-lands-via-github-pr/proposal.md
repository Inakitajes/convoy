...
- `src/worktree-squash.ts` / `src/operation-handlers.ts`: reuse of push reconciliation; new hosted-merge step.
...
- No breaking CLI change: headless `--message` and non-PR closes behave as today.
